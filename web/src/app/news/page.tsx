      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        ...
        <div className="mb-8">
          <div className="flex items-baseline gap-3 mb-2">
            <h1 className="font-bebas tracking-[2px] text-[32px]" style={{ color: '#e8eaf0' }}>
          ...
          <p className="text-sm" style={{ color: '#4a5272', maxWidth: 560 }}>
          ...
          {SLOTS.map((t) => {
            ...
            return (
              <a
                ...
                className="font-mono text-[11px] tracking-[0.5px] uppercase px-3 py-1.5 rounded-[4px] transition-colors"
                style={{
              ...
              <div className="mt-10 flex justify-center gap-2">
                {page > 1 && (
                  <a
                    ...
                    className="font-mono text-[11px] uppercase px-4 py-2 rounded-[4px] transition-colors hover:border-[#3d4562]"
                ...
                <span
                  className="font-mono text-[11px] px-4 py-2 rounded-[4px]"
